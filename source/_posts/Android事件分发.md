...
tags: Android
description: 事件分发作为Android开发中最重要的知识体系之一，了解并熟悉整套的分发机制有助于更好的分析各种点击滑动失效问题，更好去扩展控件的事件功能和开发自定义控件，同时事件分发处理也作为Android面试必问考点之一，如果能有一个全面深入地了解肯定加分不少。总结：事件分发机制很重要
---
# 引言
